        ...
        <>
            <section>
                ...
                <div
                    ...
                    <img src="./src/assets/image/doctor.png" alt="image Loading..." className='rounded-[30px]' />
                    <img src="./src/assets/image/mask_group.png" alt="image Loading..." className='absolute top-8 right-8 w-20 md:w-40 mdtop-10 md:right-10' />
